...
const TERMS_SECTIONS: { heading: string; body?: string; table?: boolean }[] = [
  ...
  },
  {
    ...
    body: "ORO may use artificial intelligence and machine learning tools to support market integrity monitoring, research, analytics, and consensus-forecast generation, as described in the AI & Collective Intelligence Policy (Volume VI). AI-generated outputs are provided for informational purposes only and do not replace independent human judgment; ORO does not warrant the accuracy of AI-generated content. ORO applies bias-mitigation and human-oversight measures to AI systems materially affecting Users, consistent with Volume VI.",
  },
  {
  ...
  {
    heading: "15. Privacy",
    body: "ORO processes personal information in accordance with the Privacy Policy (Volume III), which forms part of this Agreement. Aggregated and anonymized platform data may be used for research, academic collaboration, and AI model improvement, in accordance with the Research & Data Governance Policy (Volume IX) and applicable data protection law.",
  },
  {
  ...
  return (
    ...
    >
      ...
      >
        {activeTab === "terms" && (
          <>
            {/* Acceptance of Terms — kept at the top */}
            <div
              style={{
            ...
            >
              ...
              >
                {TERMS_SECTIONS.map((s) => (
                  <a
                    key={s.heading}
                    href={`#tma-terms-${s.heading.split(".")[0]}`}
                    style={{
                      fontSize: 11,
                      color: "var(--text-muted, #94a3b8)",
                      textDecoration: "none",
        ...
        {sections.map((item) => (
          <div
            ...
            id={
              activeTab === "terms"
                ? `tma-terms-${item.heading.split(".")[0]}`
                : undefined
            }
